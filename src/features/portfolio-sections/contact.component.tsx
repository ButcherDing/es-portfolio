import GuestbookEntries from "../guestbook/guestbook-entries/guestbook-entries.component";
import GuestbookForm from "../guestbook/guestbook-form/guestbook-form.component";
          ...
          <div className="space-y-2">
            ...
            <div className="flex max-w-xs items-center gap-3">
              ...
              <a
                rel="noopener noreferrer"
                target="_blank"
                href="https://www.linkedin.com/in/evon-c-scott/"
              >
                evon-c-scott
              </a>
            </div>
            <div className="flex max-w-xs items-center gap-3">
              <a
                rel="noopener noreferrer"
                target="_blank"
                href="https://drive.google.com/file/d/1-AKUtOCnItxMqlBwYxQO7WQ0vTGQaauO/view?usp=share_link"
                className="-full flex h-8 w-8 items-center justify-center  bg-rose-600  text-stone-900 sm:h-10 sm:w-10"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
