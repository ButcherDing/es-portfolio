...
const Home: NextPage = () => {
  return (
    <div className="space-y-12">
      ...
      <Projects />
      <Courses />
      <div className="mx-auto grid max-w-screen-xl grid-cols-1 gap-8 rounded-lg px-8 py-16 md:grid-cols-2 md:px-12 lg:px-16 xl:px-32">
        <div className="flex flex-col justify-between">
          <div className="space-y-2">
            <h2 className="text-4xl font-thin leading-tight lg:text-5xl">{`Let's talk!`}</h2>
            <div className="dark:text-stone-400">
              Get in touch for any old reason.
            </div>
            <a
